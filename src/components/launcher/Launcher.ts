...
export class Launcher {
  ...
  private readonly mascot: FamiliarMascot
  private readonly ring: HTMLSpanElement

  constructor(options: LauncherOptions) {
    this.mascot = options.mascot

    const tooltipId = `familiar-launcher-tooltip-${++tooltipCounter}`

    this.element = document.createElement('button')
    this.element.type = 'button'
    this.element.className = 'familiar-launcher'
    ...
    tooltip.className = 'familiar-launcher__tooltip'
    tooltip.id = tooltipId
    tooltip.setAttribute('role', 'tooltip')
    tooltip.textContent = options.tooltip

    this.ring = document.createElement('span')
    this.ring.className = 'familiar-launcher__ring'
  ...
  setExpanded(expanded: boolean): void {
    ...
    this.element.classList.toggle('familiar-launcher--open', expanded)
  }
  ...
  private setHovering(hovering: boolean): void {
    this.element.classList.toggle('familiar-launcher--hovering', hovering)
